...
@borg.on(admin_cmd(pattern="setgpic$"))
@errors_handler
...
@borg.on(admin_cmd(pattern="promote(?: |$)(.*)", command="promote"))
@errors_handler
...
@borg.on(admin_cmd(pattern="demote(?: |$)(.*)", command="demote"))
@errors_handler
...
@borg.on(admin_cmd(pattern="ban(?: |$)(.*)", command="ban"))
@errors_handler
async def ban(bon):
    if bon.fwd_from:
        return
...
@borg.on(admin_cmd(pattern="unban(?: |$)(.*)", command="unban"))
@errors_handler
async def nothanos(unbon):
    ...
    if not admin and not creator:
        ...
        return
    webevent = await edit_or_reply(unbon, "`Unbanning...`")
    ...
    try:
        ...
        await webevent.edit("`Uh oh my unban logic broke!`")
...
@borg.on(admin_cmd(pattern="mute(?: |$)(.*)", command="mute"))
...
@borg.on(admin_cmd(pattern="unmute(?: |$)(.*)", command="unmute"))
...
@borg.on(admin_cmd(pattern="pin($| (.*))", command="pin"))
@errors_handler
async def pin(msg):
    if msg.fwd_from:
        return
...
@borg.on(admin_cmd(pattern="unpin($| (.*))", command="unpin"))
@errors_handler
async def pin(msg):
    if msg.fwd_from:
        return
...
@borg.on(admin_cmd(pattern="kick(?: |$)(.*)", command="kick"))
@errors_handler
async def kick(usr):
    if usr.fwd_from:
        return
    ...
    if not user:
        ...
        return
    webevent = await edit_or_reply(usr, "`Kicking...`")
    try:
    ...
    if reason:
        ...
        await webevent.edit(f"`Kicked` [{user.first_name}](tg://user?id={user.id})`!`")
    if BOTLOG:
...
@borg.on(admin_cmd(pattern="iundlt$", command="iundlt"))
async def _(event):
    if event.fwd_from:
        return
